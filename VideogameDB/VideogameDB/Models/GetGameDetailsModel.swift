...
// MARK: - GetGameDetailsModel
struct GetGameDetailsModel: Codable {
    let id: Int
...
struct DetailsPlatformElement: Codable {
...
// MARK: - Requirements
struct DetailsRequirements: Codable {
    let minimum, recommended: String?
}


// MARK: - Store
struct DetailsStore: Codable {
    let id: Int
    let url: String
    let store: Developer
}
